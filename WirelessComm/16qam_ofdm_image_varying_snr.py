...
# ==========================
# Evaluation Under Varying SNR
# ==========================

SNR_range = np.arange(0, 31, 2)  # SNR values from 0 to 30 dB
ber_list = []
ser_list = []
papr_list = []
...
for test_snr in SNR_range:
    ...
    ber_list.append(ber)
    ser_list.append(ser)
    papr_list.append(avg_papr)

# Plotting Evaluation Metrics
plt.figure()
plt.plot(SNR_range, ber_list, marker='o')
plt.title("BER vs SNR")
plt.xlabel("SNR (dB)")
plt.ylabel("Bit Error Rate")
plt.grid(True)
plt.savefig("16qam_ber_vs_snr.png")

plt.figure()
plt.plot(SNR_range, ser_list, marker='x', color='orange')
plt.title("SER vs SNR")
plt.xlabel("SNR (dB)")
plt.ylabel("Symbol Error Rate")
plt.grid(True)
plt.savefig("16qam_ser_vs_snr.png")

plt.figure()
plt.plot(SNR_range, papr_list, marker='s', color='green')
plt.title("PAPR vs SNR")
plt.xlabel("SNR (dB)")
plt.ylabel("Peak to Average Power Ratio (dB)")
plt.grid(True)
plt.savefig("16qam_papr_vs_snr.png")